...
### 🟩 Program 1 – Activity Lifecycle + Hello Android
...
### 🟦 Program 2 – Radio Buttons + Submit Button

Create an application using RadioButtons and a Submit button.
On clicking submit:
...
https://github.com/user-attachments/assets/12d42a63-1bae-44fc-8f9a-32e31fccba0e

### 🟨 Program 3 – Currency Converter App

Develop an application to convert INR into:
...
Develop a basic calculator that performs:
...
Navigates from one Activity to another
